...
use Travelpayouts\Vendor\Carbon\CarbonTimeZone;
use Closure;
...
trait Test
{
     ...
     *
     * @return \Travelpayouts\Vendor\Carbon\CarbonImmutable|\Carbon\Carbon|null
     */
    protected static function getMockedTestNow($tz)
    {
        ...
        /* @var \Travelpayouts\Vendor\Carbon\CarbonImmutable|\Carbon\Carbon|null $testNow */
    ...
    {
        /** @var \Travelpayouts\Vendor\Carbon\CarbonImmutable|\Carbon\Carbon $testInstance */
