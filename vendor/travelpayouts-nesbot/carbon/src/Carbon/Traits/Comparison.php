...
use Travelpayouts\Vendor\Carbon\Exceptions\BadComparisonUnitException;
...
trait Comparison
{
     ...
     * ```
     *
     * @param \Travelpayouts\Vendor\Carbon\Carbon|\DateTimeInterface|mixed $date
     *
     * @see equalTo()
     *
     * @return bool
     ...
     * ```
     *
     * @param \Travelpayouts\Vendor\Carbon\Carbon|\DateTimeInterface|mixed $date1
     * @param \Travelpayouts\Vendor\Carbon\Carbon|\DateTimeInterface|mixed $date2
     ...
     * @param \Travelpayouts\Vendor\Carbon\Carbon|\DateTimeInterface|string|null $date   instance to compare with or null to use current day.
     *
     * @return bool
     */
     ...
     * @param \Travelpayouts\Vendor\Carbon\Carbon|\DateTimeInterface|null $date instance to compare with or null to use current day.
     *
     ...
     * ```
     *
     * @param \Travelpayouts\Vendor\Carbon\Carbon|\DateTimeInterface|string|null $date       The instance to compare with or null to use current day.
     ...
     * ```
     *
     * @param \Travelpayouts\Vendor\Carbon\Carbon|\DateTimeInterface|null $date       The instance to compare with or null to use the current date.
     * @param bool                                   $ofSameYear Check if it is the same month in the same year.
     *
     * @return bool
     */
     ...
     * ```
     *
     * @param \Travelpayouts\Vendor\Carbon\Carbon|\DateTimeInterface|null $date The instance to compare with or null to use current day.
     *
     * @return bool
     */
