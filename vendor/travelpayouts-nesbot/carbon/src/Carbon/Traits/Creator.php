...
use Travelpayouts\Vendor\Carbon\Exceptions\InvalidDateException;
use Travelpayouts\Vendor\Carbon\Exceptions\InvalidFormatException;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null)
    {
        ...
        /** @var \Travelpayouts\Vendor\Carbon\CarbonImmutable|\Carbon\Carbon|null $mock */
     ...
     * @param \Travelpayouts\Vendor\Symfony\Component\Translation\TranslatorInterface $translator optional custom translator to use for macro-formats
     *
     * @throws InvalidFormatException
     *
     * @return static|false
