...
namespace Travelpayouts\Vendor\Carbon\Traits;
use Travelpayouts\Vendor\Carbon\CarbonInterface;
use Travelpayouts\Vendor\Carbon\Exceptions\InvalidTypeException;
use Travelpayouts\Vendor\Carbon\Exceptions\NotLocaleAwareException;
use Travelpayouts\Vendor\Carbon\Language;
use Travelpayouts\Vendor\Carbon\Translator;
use Travelpayouts\Vendor\Carbon\TranslatorStrongTypeInterface;
use Closure;
use Travelpayouts\Vendor\Symfony\Component\Translation\TranslatorBagInterface;
use Travelpayouts\Vendor\Symfony\Component\Translation\TranslatorInterface;
use Travelpayouts\Vendor\Symfony\Contracts\Translation\LocaleAwareInterface;
use Travelpayouts\Vendor\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

// @codeCoverageIgnoreStart
if (interface_exists('Travelpayouts\\Vendor\\Symfony\Contracts\Translation\\TranslatorInterface') &&
    !interface_exists('Travelpayouts\\Vendor\\Symfony\Component\Translation\\TranslatorInterface')
) {
    class_alias(
        'Travelpayouts\\Vendor\\Symfony\Contracts\Translation\\TranslatorInterface',
        'Travelpayouts\\Vendor\\Symfony\Component\Translation\\TranslatorInterface'
    );
}
...
trait Localization
{
     ...
     * Default translator.
     *
     * @var \Travelpayouts\Vendor\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @return \Travelpayouts\Vendor\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @param \Travelpayouts\Vendor\Symfony\Component\Translation\TranslatorInterface $translator
     *
     * @return void
     */
     ...
     *
     * @param \Travelpayouts\Vendor\Symfony\Component\Translation\TranslatorInterface $translator the translator to use
     ...
     * @param string|null                                        $locale     current locale used if null
     * @param string|null                                        $default    default value if translation returns the key
     * @param \Travelpayouts\Vendor\Symfony\Component\Translation\TranslatorInterface $translator an optional translator to use
     *
     * @return string
     */
     ...
     * @param \Travelpayouts\Vendor\Symfony\Component\Translation\TranslatorInterface|null $translator
     ...
     * @param \Travelpayouts\Vendor\Symfony\Component\Translation\MessageCatalogueInterface $catalogue
     *
     * @return mixed
     */
