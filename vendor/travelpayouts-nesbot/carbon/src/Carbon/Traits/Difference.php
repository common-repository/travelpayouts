...
use Travelpayouts\Vendor\Carbon\CarbonInterval;
use Travelpayouts\Vendor\Carbon\CarbonPeriod;
...
trait Difference
{
     ...
     * current one).
     *
     * @param \Travelpayouts\Vendor\Carbon\CarbonInterface|\DateTimeInterface|string|null $date
