...
namespace Travelpayouts\Vendor\Carbon\Exceptions;
...
class NotLocaleAwareException extends BaseInvalidArgumentException implements InvalidArgumentException
{
    ...
    public function __construct($object, $code = 0, Throwable $previous = null)
    {
        ...
        parent::__construct("$dump does neither implements \Travelpayouts\Vendor\Symfony\Contracts\Translation\LocaleAwareInterface nor getLocale() method.", $code, $previous);
    }
}
