...
use Travelpayouts\Vendor\Carbon\Exceptions\EndLessPeriodException;
...
use Travelpayouts\Vendor\Carbon\Exceptions\InvalidPeriodDateException;
use Travelpayouts\Vendor\Carbon\Exceptions\InvalidPeriodParameterException;
use Travelpayouts\Vendor\Carbon\Exceptions\NotACarbonClassException;
use Travelpayouts\Vendor\Carbon\Exceptions\NotAPeriodException;
use Travelpayouts\Vendor\Carbon\Exceptions\UnknownGetterException;
use Travelpayouts\Vendor\Carbon\Exceptions\UnknownMethodException;
use Travelpayouts\Vendor\Carbon\Exceptions\UnreachableException;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     *
     * @param \Travelpayouts\Vendor\Carbon\Carbon|\Carbon\CarbonPeriod|\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return bool
     */
     ...
     *
     * @param \Travelpayouts\Vendor\Carbon\CarbonPeriod|\DatePeriod|string $period
     *
     * @return bool
     */
     ...
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     *
     * @param \Travelpayouts\Vendor\Carbon\Carbon $current
     * @param int            $key
     *
     * @return bool|string
     */
     ...
     * @param \Travelpayouts\Vendor\Carbon\Carbon|\Carbon\CarbonPeriod|\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \Travelpayouts\Vendor\Carbon\CarbonInterface
     */
