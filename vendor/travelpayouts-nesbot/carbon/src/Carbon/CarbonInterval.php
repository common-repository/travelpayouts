...
namespace Travelpayouts\Vendor\Carbon;
use Travelpayouts\Vendor\Carbon\Exceptions\BadFluentConstructorException;
use Travelpayouts\Vendor\Carbon\Exceptions\BadFluentSetterException;
use Travelpayouts\Vendor\Carbon\Exceptions\InvalidCastException;
use Travelpayouts\Vendor\Carbon\Exceptions\InvalidIntervalException;
use Travelpayouts\Vendor\Carbon\Exceptions\OutOfRangeException;
use Travelpayouts\Vendor\Carbon\Exceptions\ParseErrorException;
use Travelpayouts\Vendor\Carbon\Exceptions\UnitNotConfiguredException;
use Travelpayouts\Vendor\Carbon\Exceptions\UnknownGetterException;
use Travelpayouts\Vendor\Carbon\Exceptions\UnknownSetterException;
use Travelpayouts\Vendor\Carbon\Exceptions\UnknownUnitException;
use Travelpayouts\Vendor\Carbon\Traits\IntervalRounding;
use Travelpayouts\Vendor\Carbon\Traits\IntervalStep;
use Travelpayouts\Vendor\Carbon\Traits\MagicParameter;
use Travelpayouts\Vendor\Carbon\Traits\Mixin;
use Travelpayouts\Vendor\Carbon\Traits\Options;
use Travelpayouts\Vendor\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @throws \Travelpayouts\Vendor\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
    ...
    public function forHumans($syntax = null, $short = false, $parts = -1, $options = null)
    {
        ...
        /** @var \Travelpayouts\Vendor\Symfony\Component\Translation\Translator $translator */
