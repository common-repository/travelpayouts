...
namespace Travelpayouts\Vendor\Brick\Math;
use Travelpayouts\Vendor\Brick\Math\Exception\DivisionByZeroException;
use Travelpayouts\Vendor\Brick\Math\Exception\IntegerOverflowException;
use Travelpayouts\Vendor\Brick\Math\Exception\MathException;
use Travelpayouts\Vendor\Brick\Math\Exception\NegativeNumberException;
use Travelpayouts\Vendor\Brick\Math\Exception\NumberFormatException;
use Travelpayouts\Vendor\Brick\Math\Internal\Calculator;
