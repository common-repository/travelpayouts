...
namespace Travelpayouts\Vendor\Doctrine\Deprecations;
use Travelpayouts\Vendor\Psr\Log\LoggerInterface;
 ...
 * \Travelpayouts\Vendor\Doctrine\Deprecations\Deprecation::enableTrackingDeprecations();
 *
 *  - Uses @trigger_error with E_USER_DEPRECATED
 * \Travelpayouts\Vendor\Doctrine\Deprecations\Deprecation::enableWithTriggerError();
 *
 *  - Sends deprecation messages via a PSR-3 logger
 * \Travelpayouts\Vendor\Doctrine\Deprecations\Deprecation::enableWithPsrLogger($logger);
 *
