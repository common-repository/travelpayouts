...
namespace Travelpayouts\Vendor\Ramsey\Uuid\Math;
use Travelpayouts\Vendor\Brick\Math\BigDecimal;
use Travelpayouts\Vendor\Brick\Math\BigInteger;
use Travelpayouts\Vendor\Brick\Math\Exception\MathException;
use Travelpayouts\Vendor\Brick\Math\RoundingMode as BrickMathRounding;
use Travelpayouts\Vendor\Ramsey\Uuid\Exception\InvalidArgumentException;
use Travelpayouts\Vendor\Ramsey\Uuid\Type\Decimal;
use Travelpayouts\Vendor\Ramsey\Uuid\Type\Hexadecimal;
use Travelpayouts\Vendor\Ramsey\Uuid\Type\Integer as IntegerObject;
use Travelpayouts\Vendor\Ramsey\Uuid\Type\NumberInterface;
