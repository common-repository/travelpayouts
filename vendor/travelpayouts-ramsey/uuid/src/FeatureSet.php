...
namespace Travelpayouts\Vendor\Ramsey\Uuid;
use Travelpayouts\Vendor\Ramsey\Uuid\Builder\BuilderCollection;
use Travelpayouts\Vendor\Ramsey\Uuid\Builder\FallbackBuilder;
use Travelpayouts\Vendor\Ramsey\Uuid\Builder\UuidBuilderInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Codec\CodecInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Codec\GuidStringCodec;
use Travelpayouts\Vendor\Ramsey\Uuid\Codec\StringCodec;
use Travelpayouts\Vendor\Ramsey\Uuid\Converter\Number\GenericNumberConverter;
use Travelpayouts\Vendor\Ramsey\Uuid\Converter\NumberConverterInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Converter\Time\GenericTimeConverter;
use Travelpayouts\Vendor\Ramsey\Uuid\Converter\Time\PhpTimeConverter;
use Travelpayouts\Vendor\Ramsey\Uuid\Converter\TimeConverterInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\DceSecurityGenerator;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\DceSecurityGeneratorInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\NameGeneratorFactory;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\NameGeneratorInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\PeclUuidNameGenerator;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\PeclUuidRandomGenerator;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\PeclUuidTimeGenerator;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\RandomGeneratorFactory;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\RandomGeneratorInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\TimeGeneratorFactory;
use Travelpayouts\Vendor\Ramsey\Uuid\Generator\TimeGeneratorInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Guid\GuidBuilder;
use Travelpayouts\Vendor\Ramsey\Uuid\Math\BrickMathCalculator;
use Travelpayouts\Vendor\Ramsey\Uuid\Math\CalculatorInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Nonstandard\UuidBuilder as NonstandardUuidBuilder;
use Travelpayouts\Vendor\Ramsey\Uuid\Provider\Dce\SystemDceSecurityProvider;
use Travelpayouts\Vendor\Ramsey\Uuid\Provider\DceSecurityProviderInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Provider\Node\FallbackNodeProvider;
use Travelpayouts\Vendor\Ramsey\Uuid\Provider\Node\NodeProviderCollection;
use Travelpayouts\Vendor\Ramsey\Uuid\Provider\Node\RandomNodeProvider;
use Travelpayouts\Vendor\Ramsey\Uuid\Provider\Node\SystemNodeProvider;
use Travelpayouts\Vendor\Ramsey\Uuid\Provider\NodeProviderInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Provider\Time\SystemTimeProvider;
use Travelpayouts\Vendor\Ramsey\Uuid\Provider\TimeProviderInterface;
use Travelpayouts\Vendor\Ramsey\Uuid\Rfc4122\UuidBuilder as Rfc4122UuidBuilder;
use Travelpayouts\Vendor\Ramsey\Uuid\Validator\GenericValidator;
use Travelpayouts\Vendor\Ramsey\Uuid\Validator\ValidatorInterface;
