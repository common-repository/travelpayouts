 ...
 *
 * ``` php
 * $collection = new \Travelpayouts\Vendor\Ramsey\Collection\Collection('My\\Foo');
 ...
 * namespace My\Foo;
 *
 * class FooCollection extends \Travelpayouts\Vendor\Ramsey\Collection\AbstractCollection
 * {
