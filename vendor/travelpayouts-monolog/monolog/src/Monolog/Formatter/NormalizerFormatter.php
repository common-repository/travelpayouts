...
namespace Travelpayouts\Vendor\Monolog\Formatter;

use Exception;
use Travelpayouts\Vendor\Monolog\Utils;
...
class NormalizerFormatter implements FormatterInterface
{
    ...
    public function __construct($dateFormat = null, $maxDepth = 9)
    {
        ...
        if (!function_exists('json_encode')) {
            throw new \RuntimeException('PHP\'s json extension is required to use Travelpayouts\Vendor\Monolog\'s NormalizerFormatter');
        }
    }
