...
namespace Travelpayouts\Vendor\Monolog;
use Travelpayouts\Vendor\Monolog\Handler\HandlerInterface;
use Travelpayouts\Vendor\Monolog\Handler\StreamHandler;
use Travelpayouts\Vendor\Psr\Log\LoggerInterface;
use Travelpayouts\Vendor\Psr\Log\InvalidArgumentException;
use Exception;
