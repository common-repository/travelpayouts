...
use function chmod;
use Travelpayouts\Vendor\DI\Definition\ArrayDefinition;
use Travelpayouts\Vendor\DI\Definition\DecoratorDefinition;
use Travelpayouts\Vendor\DI\Definition\Definition;
use Travelpayouts\Vendor\DI\Definition\EnvironmentVariableDefinition;
...
use Travelpayouts\Vendor\DI\Definition\Reference;
use Travelpayouts\Vendor\DI\Definition\Source\DefinitionSource;
use Travelpayouts\Vendor\DI\Definition\StringDefinition;
...
use Travelpayouts\Vendor\Opis\Closure\SerializableClosure;
use function rename;
    ...
    private function compileDefinition(string $entryName, Definition $definition) : string
    {
        ...
        switch (true) {
            ...
            case $definition instanceof StringDefinition:
                ...
                $code = 'return \Travelpayouts\Vendor\DI\Definition\StringDefinition::resolveExpression(' . $entryName . ', ' . $expression . ', $this->delegateContainer);';
                break;
        ...
        if (!$isOptional) {
            throw new \Travelpayouts\Vendor\DI\Definition\Exception\InvalidDefinition("The environment variable '{$definition->getVariableName()}' has not been defined");
        }
        return $defaultValue;
PHP;
                break;
    ...
    /**
     * @throws \Travelpayouts\Vendor\DI\Definition\Exception\InvalidDefinition
     */
