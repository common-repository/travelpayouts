...
use Travelpayouts\Vendor\DI\Definition\ArrayDefinitionExtension;
use Travelpayouts\Vendor\DI\Definition\EnvironmentVariableDefinition;
use Travelpayouts\Vendor\DI\Definition\Helper\AutowireDefinitionHelper;
use Travelpayouts\Vendor\DI\Definition\Helper\CreateDefinitionHelper;
...
if (! function_exists('Travelpayouts\Vendor\DI\create')) {
    /**
...
if (! function_exists('Travelpayouts\Vendor\DI\autowire')) {
    /**
