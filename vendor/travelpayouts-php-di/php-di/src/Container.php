...
use Travelpayouts\Vendor\DI\Definition\FactoryDefinition;
use Travelpayouts\Vendor\DI\Definition\Helper\DefinitionHelper;
use Travelpayouts\Vendor\DI\Definition\InstanceDefinition;
use Travelpayouts\Vendor\DI\Definition\ObjectDefinition;
use Travelpayouts\Vendor\DI\Definition\Resolver\DefinitionResolver;
use Travelpayouts\Vendor\DI\Definition\Resolver\ResolverDispatcher;
use Travelpayouts\Vendor\DI\Definition\Source\DefinitionArray;
use Travelpayouts\Vendor\DI\Definition\Source\MutableDefinitionSource;
use Travelpayouts\Vendor\DI\Definition\Source\ReflectionBasedAutowiring;
use Travelpayouts\Vendor\DI\Definition\Source\SourceChain;
use Travelpayouts\Vendor\DI\Definition\ValueDefinition;
use Travelpayouts\Vendor\DI\Invoker\DefinitionParameterResolver;
use Travelpayouts\Vendor\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use Travelpayouts\Vendor\Invoker\Invoker;
use Travelpayouts\Vendor\Invoker\InvokerInterface;
use Travelpayouts\Vendor\Invoker\ParameterResolver\AssociativeArrayResolver;
use Travelpayouts\Vendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use Travelpayouts\Vendor\Invoker\ParameterResolver\DefaultValueResolver;
use Travelpayouts\Vendor\Invoker\ParameterResolver\NumericArrayResolver;
use Travelpayouts\Vendor\Invoker\ParameterResolver\ResolverChain;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. \Travelpayouts\Vendor\DI\get().
     *
