...
if (!class_exists('TravelpayoutsSettingsFramework_Travelpayouts_Sortby')) {
    class TravelpayoutsSettingsFramework_Travelpayouts_Sortby
    {
        ...
        public function enqueue()
        {
            ...
            wp_enqueue_script(
                ...
                plugin_dir_url(__FILE__) . 'field_sortby.min.js',
