...
if (!class_exists('TravelpayoutsSettingsFramework_Travelpayouts_Platform_Select')) {

    class TravelpayoutsSettingsFramework_Travelpayouts_Platform_Select
    {
        /**
         * Field Constructor.
        ...
        public function enqueue()
        {
            wp_enqueue_script(
                ...
                Travelpayouts::getAlias('@webadmin/redux/extensions/travelpayouts_platform_select/field_travelpayouts_platform_select.min.js'),
                ['jquery'],
                time(),
                true
            );
