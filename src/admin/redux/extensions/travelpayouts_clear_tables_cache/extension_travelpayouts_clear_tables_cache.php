...
// Don't duplicate me!
if (!class_exists('TravelpayoutsSettingsFramework_extension_travelpayouts_clear_tables_cache')) {

    /**
     * Main TravelpayoutsSettingsFramework custom_field extension class
     * @since       3.1.6
     */
    class TravelpayoutsSettingsFramework_extension_travelpayouts_clear_tables_cache extends TravelpayoutsSettingsFramework
    {
        public $field_name;
        // Protected vars
        protected $parent;
        ...
        public function __construct($reduxFramework)
        {
            ...
            $this->field_name = 'travelpayouts_clear_tables_cache';
