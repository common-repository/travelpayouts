...
if (!class_exists('TravelpayoutsSettingsFramework_Travelpayouts_Sorter')) {
    class TravelpayoutsSettingsFramework_Travelpayouts_Sorter
    {
        ...
        public function enqueue()
        {
            wp_enqueue_script(
                ...
                plugin_dir_url(__FILE__) . 'travelpayouts_sorter.min.js',
