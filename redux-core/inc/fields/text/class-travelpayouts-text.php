...
if ( ! class_exists( 'Redux_Travelpayouts_Text', false ) ) {

	/**
	 * Class Redux_Travelpayouts_Text
	 */
	class Redux_Travelpayouts_Text extends Redux_Travelpayouts_Field {
		...
		public function enqueue() {
			if ( $this->parent->args['dev_mode'] ) {
				wp_enqueue_style( 'redux-field-text-css', Redux_Travelpayouts_Core::$url . 'inc/fields/text/redux-text.css', array(), $this->timestamp, 'all' );
			}
		}
...
class_alias( 'Redux_Travelpayouts_Text', 'TravelpayoutsSettingsFramework_Text' );
